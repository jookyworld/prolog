...
public interface WorkoutSetRepository extends JpaRepository<WorkoutSet, Long> {
    ...
    """,
            nativeQuery = true)
    List<String> findTopBodyPartsByFrequency(@Param("userId") Long userId, @Param("since") LocalDateTime since);
    ...
    """,
            nativeQuery = true)
    List<ExerciseInfo> findTopExerciseByBodyPart(
            @Param("userId") Long userId, @Param("since") LocalDateTime since, @Param("bodyPart") String bodyPart);
    ...
    """,
            nativeQuery = true)
    List<ExerciseSessionInfo> findRecentSessionsByExercise(
    ...
    """)
    List<WorkoutSet> findBySessionAndExercise(@Param("sessionId") Long sessionId, @Param("exerciseId") Long exerciseId);
}
