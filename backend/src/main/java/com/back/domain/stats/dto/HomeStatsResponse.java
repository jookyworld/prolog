...
public record HomeStatsResponse(
    ...
    public record ThisWeek(int workouts) {}

    public record ThisMonth(int workouts) {}
    ...
    public record ExerciseProgress(
            Long exerciseId, String exerciseName, BodyPart bodyPart, List<ExerciseSession> sessions) {}
    ...
    public record SetDetail(double weight, int reps) {}
}
