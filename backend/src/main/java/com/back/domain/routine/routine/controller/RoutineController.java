...
public class RoutineController {
    ...
    @PostMapping
    public RoutineDetailResponse createRoutine(
            @AuthenticationPrincipal UserPrincipal principal, @Valid @RequestBody RoutineCreateRequest request) {
