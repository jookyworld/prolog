    ...
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t border-white/10 px-6 py-6">
        <div className="max-w-3xl mx-auto flex gap-6">
          <Link href="/terms" className="text-sm text-muted hover:text-white transition-colors">서비스 이용약관</Link>
          <Link href="/privacy" className="text-sm text-primary">개인정보 처리방침</Link>
        </div>
      </footer>
    </div>
  );
